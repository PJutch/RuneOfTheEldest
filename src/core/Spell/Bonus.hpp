...
namespace core {
	...
	public:
		BonusSpell(ConditionalBonus::Bonuses bonuses, double mana_, const sf::Texture& icon, std::string_view name) :
			Spell{icon, name}, mana{mana_}, bonus{std::make_shared<Bonus>(bonuses, icon, name)} {}
