...
TEST(Area, right) {
    int right = generation::Area{{2, 3, 7, 4}, 0}.right();
    EXPECT_EQ(right, 9);
}

TEST(Area, bottom) {
    int bottom = generation::Area{{2, 3, 7, 4}, 0}.bottom();
    EXPECT_EQ(bottom, 7);
}

TEST(Area, splitX) {
    auto [area1, area2] = generation::Area{{1, 2, 5, 3}, 0}.splitX(3);
...
TEST(Area, splitY) {
    auto [area1, area2] = generation::Area{{1, 2, 5, 3}, 0}.splitY(3);
...
TEST(Area, splitXHorizontalPassages) {
    generation::Area area{{1, 2, 5, 3}, 0};
...
TEST(Area, splitYVerticalPassages) {
    generation::Area area{{1, 2, 3, 5}, 0};
    area.addTopPassage(2);
